...
| 6 | 安全与正式交付准备 | **进行中** | B6-G0 complete@`c1d0458`；B6-G1 complete@`bdc98af`；B6-G2 complete@`e0c91df`；B6-G3 Windows Integrity Local Gate complete@`1a07447` + audit `d73cf3f`；B6-G4 Staging Infrastructure Gate 等待独立批准 |
...
- B6-G4：**pending approval / not started**
...
**进行中；B6-G0 complete，B6-G1 complete，B6-G2 complete，B6-G3 complete，B6-G4 pending approval。**
