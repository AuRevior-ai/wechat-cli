...
| 6 | 安全与正式交付准备 | **进行中** | B6-G0 complete@`c1d0458`；B6-G1 Update Trust Local Gate complete@`bdc98af`；B6-G2 Admin & Data Security Local Gate 等待独立批准 |
...
- B6-G2：**pending approval / not started**
