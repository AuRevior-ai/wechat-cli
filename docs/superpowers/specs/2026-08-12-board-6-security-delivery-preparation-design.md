...
> **APPROVED DESIGN — B6-G0 source integration complete; B6-G1 pending approval; every later gate remains independently authorized.**
>
> Date: 2026-08-12
>
...
>
> Current authorization boundary: B6-G0 is complete. B6-G1 is **not** authorized. No cloud/staging/production mutation, credential rotation, code-signing purchase/application, release publication, push, merge, reset, rebase, or amend is authorized by this document.
...
Board 6 is **in progress** on `board6/security-delivery-preparation`. B6-G0 source integration and packaging-boundary cleanup are complete through local HEAD `c1d045895a044dbb4c9998a787c77775654074fa`. The eight approved product candidates were selectively integrated onto the fresh main-based lineage, acceptance-only helpers were not imported as product dependencies, and generic packaging path safety was extracted into `scripts/packaging_paths.py`. **B6-G1 remains pending approval.**

The risk-card “Current behavior” text below records the behavior observed at design time before B6-G0 closure where applicable; D1/D2 are now locally remediated by B6-G0, while A/B/C-domain implementation remains pending later gates.
...
This design and the companion implementation plan are approved, but approval of the documents never authorizes a gate by itself. **B6-G0 has been separately authorized and completed. B6-G1 is pending approval.**

Current closure/governance repair does not authorize:

- any B6-G1 or later implementation code change;
...
The next possible implementation gate is **B6-G1 Update Trust Local Gate**, and it requires a new explicit user authorization after this governance closure.
